...
file = file.replace(/>Um acervo premium e atualizado para sua equipe importar, ensaiar e\n\s*ministrar com excelência. Menos tempo procurando. Mais tempo adorando.</g, '>{t("library.description", "Um acervo premium e atualizado para sua equipe importar, ensaiar e ministrar com excelência. Menos tempo procurando. Mais tempo adorando.")}<');
...
file = file.replace(/Desmarcar as (\{\w+\.size\}) selecionadas/g, '{t("library.deselect_all", "Desmarcar as {{count}} selecionadas", { count: $1 })}');
