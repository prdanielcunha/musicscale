    ...
    <>
      <div className="pointer-events-auto z-[110] relative rounded-full">
        <button
          ...
          aria-label={t('globalCreate.trigger', 'Criar')}
          className="flex h-[50px] min-w-11 flex-col items-center justify-center gap-0.5 rounded-2xl px-1 text-white/70 hover:bg-white/5 focus-visible:ring-2 focus-visible:ring-primary motion-reduce:transition-none"
        >
